...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[⭐ 헤더 톤 — 분석가형 (2026-04-29 도입)]

**Template B 국내 공시**: `[{{기업명}}({{6자리 종목코드}}): {{한 줄 시사점}}]`
**Template A·C·D**: `[NODE Research {{섹터}} — {{한 줄 시사점}}]` 다음 줄 `▶ ...`
**Template E 속보**: 헤더 생략 (기존 그대로)

**한 줄 시사점 작성 가이드**:
- 본문 핵심을 **방향성·맥락**까지 포함해 압축 (단순 사실 전달 X)
- ✅ OK 예시: "주주환원 본격화", "AI 패키징 캐파 선제 확보", "1Q26 컨센 상회",
  "HBM 수요 대응", "테스트 캐파 2배 증설", "관세 충격 가시화", "공급 부족 지속",
  "임베디드 기판 경쟁 본격화", "MLCC 양극화 심화", "FDA 승인 — 미국 진출 본격화"
- ❌ 절대 금지 (컴플라이언스):
  - 투자의견: "Buy", "Hold", "Sell", "강력 매수", "매도 권고"
  - 목표가: "목표가 X만원 상향", "적정주가 X원"
  - 수혜종목 창작: "X 수혜주", "X 최선호주", "X 추천"
  - 과장: "초강세", "폭등 임박", "필수 보유"
- ⚠️ 톤: **방향성·시사점만**. 평가는 분석가가, 판단은 투자자가.

**예시 비교**:
| 무미건조 (금지) | 분석가형 (권장) |
|---|---|
| `[삼성전자 자사주 매매 현황]` | `[삼성전자(005930): 자사주 5,000만주 소각 — 주주환원 본격화]` |
| `[삼성전기 베트남 투자 결정]` | `[삼성전기(009150): 베트남 FC-BGA 1.8조 투자 — AI 패키징 캐파 선제 확보]` |
| `[NODE Research IT부품]` | `[NODE Research IT부품 — MLCC 양극화 심화]` |

**ticker(6자리) 모르면 종목명만 표기 가능** (`[기업명: 시사점]`).
**시사점이 정말 모호하면 무미건조 fallback 허용** (`[기업명 공시유형]`).

━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[작성 원칙]
- R1~R8 규칙 절대 준수 (단, R1 헤더는 위 [헤더 톤] 가이드로 보강됨)
